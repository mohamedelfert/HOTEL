...
$sql="insert into employees (EFNAME,ELNAME,EADDRESS,ENATIONALID,EPHONE,EMOBILE,EGENDER,EDATEOFBIRTH)
	values('".$_REQUEST["fn"]."','".$_REQUEST["ln"]."','".$_REQUEST["ad"]."','".$_REQUEST["ni"]."','".$_REQUEST["ph"]."','".$_REQUEST["mb"]."',".($_REQUEST["ge"]==0?0:1).",'".$DoB."')";
