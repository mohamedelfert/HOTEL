...
<header class="w3-display-container w3-content" style="max-width:1500px;">
  <img class="w3-image" src="img/hotel.jpg" alt="The Hotel" style="min-width:1000px" width="1500" height="800">
  <div class="w3-display-left w3-padding w3-col l6 m8">
    <div class="w3-container w3-red">
      <h2><i class="fa fa-bed w3-margin-right"></i>LA LA LAND</h2>
    </div>
...
<div class="w3-content" style="max-width:1532px;">
  ...
  <div class="w3-row-padding w3-padding-16">
    <div class="w3-third w3-margin-bottom">
      <img src="img/room_single.jpg" alt="Norway" style="width:100%">
    ...
    <div class="w3-third w3-margin-bottom">
      <img src="img/room_double.jpg" alt="Norway" style="width:100%">
      <div class="w3-container w3-white">
        <h3>Double Room</h3>
    ...
    <div class="w3-third w3-margin-bottom">
      <img src="img/room_deluxe.jpg" alt="Norway" style="width:100%">
      <div class="w3-container w3-white">
        <h3>Deluxe Room</h3>
  ...
  <div class="w3-row-padding w3-large w3-center" style="margin:32px 0">
    <div class="w3-third"><i class="fa fa-map-marker w3-text-red"></i> tanta</div>
    <div class="w3-third"><i class="fa fa-phone w3-text-red"></i> Phone: 01021498867</div>
    <div class="w3-third"><i class="fa fa-envelope w3-text-red"></i> Email:aawny8957@gmail.com</div>
  </div>
